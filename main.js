const API_KEY =
  "live_cwJduR2QZH0de7yGS2S2znpPmau5VZtfRhve08xMT8pdDcxRJA57tsmwur7SS1rp";
...
fetch("https://api.thecatapi.com/v1/breeds?limit=10&page=0", {
  ...
  .then((data) => {
    ...
    for (let i = 0; i < data.length; i++) {
      allbreeds +=
        "Name: " + data[i].name + "<br>" + "\t Id: " + data[i].id + "<br>";
    }
...
breedBtn.addEventListener("click", function () {
  ...
  SearchURL +=
    "?limit=20&breed_ids=" + breedId + "&has_breeds=true&include_breeds=false";
});
